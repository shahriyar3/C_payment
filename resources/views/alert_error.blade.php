        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <form class="requires-validation" novalidate name="payment-form" method="post">
                        <div class="col-md-12">
                            ...
                            @if(!empty($error))
                                <div class="alert alert-danger">
                                    <p class="text-black-50">{!! trans('message.' . $error) !!}</p>
                                </div>
                            @endif

                            @if(!empty($gateway_error))
                                <div class="alert alert-danger">
                                    <p class="text-black-50">{!! trans('message.' . $gateway_error) !!}</p>
                                </div>
                            @endif
