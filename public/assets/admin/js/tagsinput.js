...
;(function ( $, window, document, undefined ) {
    ...
    var _createTagInput = function(input, tagDataSeparator) {
        ...
        /*var labels = '<select multiple class="mab-jquery-taginput-data hide">';
        labels += tags.forEach(myFunction);
        labels += '</select>';

        function myFunction(item, index) {
            return '<option selected value="' + index + '">' + index + '</option>';
        }*/
    ...
    var _createTag = function(tag) {
        return '<span class="label label-primary badge badge-primary" data-tag="' + tag + '">' + tag + ' <span class="fa fa-remove"></span></span>';
    };
    ...
    Plugin.prototype = {
        ...
        init: function(element) {
            ...
            tagInputContainer.on('click', 'span.fa', function(e) {
